...
class Accessor extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('Accessor_model', 'accessor');
    }
    ...
    public function index()
    {
        $data = array(
            ...
            'query' => $this->db->get_where('pengajuan',  array('status' => '3')),
            'no' => '1'
        );
        ...
        $this->load->view('accessor/index', $data);
    ...
    public function profile()
    {
        ...
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('accessor/profile', $data);
        $this->load->view('templates/footer');
    }
    public function edit()
    {
        ...
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('accessor/edit', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function pengajuan()
    {
        ...
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('accessor/pengajuan', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function tambahPengajuan()
    {
        ...
        //     'required' => 'Tambahkan contoh desain yang diinginkan'
        // ]);
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->accessor->tambahPengajuan($data);
    ...
    public function ubahPassword()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('templates/sidebar', $data);
            $this->load->view('templates/topbar', $data);
            $this->load->view('accessor/ubahPassword', $data);
            $this->load->view('templates/footer');
        } else {
            ...
            if (!password_verify($passLama, $passDb)) {
                ...
                redirect('accessor/ubahPassword', 'refresh');
            } else {
                if ($passLama == $passNew) {
